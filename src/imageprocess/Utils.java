...
public final class Utils {
     ...
     */
    private static BufferedImage matToBufferedImage(opencv_core.Mat original) {
        // init
        BufferedImage image = null;
        int width = original.arrayWidth(), height = original.arrayHeight(), channels = original.channels();
        byte[] sourcePixels = new byte[width * height * channels];
        ByteBuffer buffer = original.createBuffer();
        buffer.get(sourcePixels);
